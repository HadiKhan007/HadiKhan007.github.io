  ...
  const achievements = [
    {
      icon: FaTrophy,
      title: "20+",
      description: "Client Projects Shipped",
    ...
    <div className="min-h-screen pb-16 sm:pb-24">
      <div className="section-shell">
        ...
        <div className="mb-8 sm:mb-10 flex justify-center">
          <div className="inline-flex items-center rounded-full border border-[var(--border)] px-4 py-2 text-sm text-[var(--text-secondary)] bg-[var(--bg-card)] shadow-[0_0_24px_-8px_rgba(109,124,255,0.25)]">
            20+ Client Projects Shipped
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-16">
          <motion.div
            ...
            className="rounded-2xl p-6 sm:p-7 bg-[var(--bg-card)] border border-[var(--border)] premium-card overflow-hidden"
          >
          ...
          >
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                className="rounded-2xl p-6 bg-[var(--bg-card)] border border-[var(--border)] premium-card text-center"
              >
                <div
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)] mb-0.5">
                  {achievement.title}
                </h3>
                <p className="text-[var(--text-muted)] text-sm leading-7">
        ...
        >
          <div className="text-center mb-12">
            ...
            <h2 className="section-title text-2xl sm:text-3xl font-bold text-[var(--text-primary)] mb-2">
              Skills
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className="rounded-2xl p-6 bg-[var(--bg-card)] border border-[var(--border)] premium-card"
              >
                ...
                <div className="w-full bg-[var(--bg-elevated)] rounded-full h-1.5 mb-1 overflow-hidden">
                  <div
                    className="h-1.5 max-w-full rounded-full skill-progress-fill motion-safe:transition-[width] motion-safe:duration-700 motion-safe:ease-out"
        ...
        >
          <div className="text-center mb-12">
            <div className="section-kicker mb-3">Background</div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="rounded-3xl p-6 sm:p-8 bg-[var(--bg-card)] border border-[var(--border-subtle)] hover:border-[var(--primary)]/20 transition-all text-left">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)]">Background</h3>
              </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }} className="rounded-3xl p-6 sm:p-8 bg-[var(--bg-card)] border border-[var(--border-subtle)] hover:border-[var(--primary)]/20 transition-all text-left">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)]">What I do</h3>
              </div>
        ...
        >
          <div className="text-center mb-12">
            <div className="section-kicker mb-3">Approach</div>
            <h2 className="section-title text-2xl sm:text-3xl font-bold text-[var(--text-primary)]">
              How I work
            </h2>
          </div>
